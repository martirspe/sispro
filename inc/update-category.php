...
if (empty($imagen)) {
    $query = "SELECT CAT_imagen FROM categorias WHERE CAT_id = '$id'";
    $results = mysqli_query($open_connection, $query);
    while ($row = mysqli_fetch_array($results)) {
        $route_xampp = $row['CAT_imagen'];
    }
    $query = "UPDATE categorias SET CAT_imagen='$route_xampp', CAT_nombre='$nombre', CAT_descripcion='$descripcion', CAT_estado='$estado' WHERE CAT_id='$id'";
    $results = mysqli_query($open_connection, $query);
    if ($results == false) {
        echo '
